...
namespace ConsoleEShop
{
    public class Menu
    {
        ...
        public void Run()
        {
            ...
            {
                var roleIndex = (int)Enum.Parse(typeof(Enums.UserRoles), _choices[(int)choice - 1].UserRole.ToString());
                var currentUserRoleIndex = (int)Enum.Parse(typeof(Enums.UserRoles), userRole.ToString());
